        ...
        <div class="container py-5">
            <div class="row py-5">
                <form class="col-md-5 m-auto">
                    <div class="logo h1 text-success">Đăng ký</div>
                    <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control mt-2" name="name" placeholder="Họ và tên">
                    </div>
                    <div class="mb-3">
                        <label for="">Điện thoại</label>
                        <input type="text" class="form-control mt-2" name="phone" placeholder="Điện thoại">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col mt-2">
                            <p>Bạn đã có tài khoản ? Đăng nhập tại<a href="sign-in"> đây</a></p>
                        </div>
                    </div>
    
                    <div class="row">
                        <div class="col text-end mt-2">
                            <button type="submit" class="btn btn-success" formaction="signup">Đăng ký</button>
                        </div>
                    </div>
